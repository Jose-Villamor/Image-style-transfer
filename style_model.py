...
def inference(model, image):
    ...
    # Create our blob from the image, perform foward pass
    inp_blob = cv2.dnn.blobFromImage(resized_image, 1.0,
        (new_width, 640),
    ...
    # Reshape the output Tensor, add back the mean substruction, re-order the channels
